...
2.  **Invariants, Tech Stack & File Map**:
    ...
    *   Read when: Touching the Aira `vercel.json` rewrite, the contact form, page routing, or Next.js/Tailwind config.
...
6.  **Company Identity, Brand & Positioning**:
    *   Location: `.agents/context/company-and-brand.md`
    *   Read when: Writing or editing any customer-facing copy, page content, marketing material, or positioning — the source of truth for Bloom Matrix facts. Never invent claims not in this file; ask instead.
